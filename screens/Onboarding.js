    ...
    >
      ...
      >
        <View style={styles.page} key="1">
          ...
          <Text style={styles.pageIndicatorText}>Profile Completion: 1/3</Text>
        ...
        <View style={styles.page} key="2">
          ...
          <Text style={styles.pageIndicatorText}>Profile Completion: 2/3</Text>
          <View style={styles.pageIndicator}>
            <View style={[styles.pageDot, styles.pageDotActive]}></View>
            <View style={[styles.pageDot, styles.pageDotActive]}></View>
            <View style={styles.pageDot}></View>
        ...
        <View style={styles.page} key="3">
          ...
          <Text style={styles.pageIndicatorText}>Profile Completion: 3/3</Text>
          <View style={styles.pageIndicator}>
            <View style={[styles.pageDot, styles.pageDotActive]}></View>
            <View style={[styles.pageDot, styles.pageDotActive]}></View>
            <View style={[styles.pageDot, styles.pageDotActive]}></View>
